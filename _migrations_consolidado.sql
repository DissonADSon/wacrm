-- ============================================================
-- wacrm — 23 migrations consolidadas (rodar no schema public)
-- Gerado para colar no SQL Editor do Supabase (content-studio)
-- Seguro reexecutar: tudo usa IF NOT EXISTS / DROP IF EXISTS
-- ============================================================
