...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Confira a URL ou peça à pessoa que convidou você para enviar um novo.',
  },
  used: {
    title: 'Convite já utilizado',
    body: 'Este convite já foi aceito. Se não foi você, peça ao administrador da conta para enviar um link novo.',
  },
  expired: {
    title: 'Convite expirado',
    body: 'Este convite expirou. Peça ao administrador da conta para enviar um novo — leva alguns segundos para gerar.',
  },
  server_error: {
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                O link do convite continua válido enquanto não tiver
                expirado.
              </p>
            </div>
