...
/** Dropdown de pipelines (funis), guardando o id. Cai num input cru se ainda
 *  não houver pipeline criado. */
function PipelineSelect({
  ...
  return (
    ...
    >
      ...
      {value && !selected && (
        <option value={value}>{value} (pipeline desconhecido)</option>
      )}
    </select>
  )
}

/** Dropdown das etapas (colunas) do pipeline selecionado, guardando o id. */
function StageSelect({
  ...
  return (
    ...
    >
      ...
      {value && !selected && (
        <option value={value}>{value} (etapa desconhecida)</option>
      )}
    </select>
  )
}
      ...
      >
        ...
        {current && !hasMatch && (
          <option value={current}>
            {templateName} ({language || "desconhecido"}) — fora da lista aprovada
          </option>
        )}
      </select>
    </FieldBlock>
