...
import { DealCustomFieldsManager } from "@/components/pipelines/deal-custom-fields-manager";
...
export function PipelineSettings({
  ...
  async function handleDeletePipeline() {
    ...
    setDeleting(false);
    if (error) {
      toast.error("Falha ao excluir o pipeline");
      return;
    }
    onOpenChange(false);
    onPipelinesChanged();
            ...
            <div className="flex items-center gap-3 rounded-lg border border-red-500/30 bg-red-500/10 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Isso vai arquivar todas as oportunidades deste pipeline. Não é
                  possível desfazer.
                </p>
              </div>
            </div>
