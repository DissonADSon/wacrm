...
/** Rótulos exibidos para cada modo (o valor cru permanece em inglês na lógica/localStorage). */
...
export function AppearancePanel() {
  ...
  return (
    <section className="max-w-3xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Aparência"
        description="Defina o modo e a cor de destaque usados em todo o app. Salvo neste dispositivo — experimente, muda na hora."
      />
...
function ModeCard({
  ...
  return (
    <button
      ...
      aria-label={`Usar modo ${MODE_LABELS[mode]}`}
      className={cn(
