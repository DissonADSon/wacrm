  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        ...
        description="A moeda usada em novas oportunidades e nos totais do pipeline e do painel."
      />
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Novas oportunidades usam esta moeda por padrão, e os totais do
            pipeline e do painel são exibidos nela. Oportunidades existentes
            mantêm a moeda com que foram salvas.
          </CardDescription>
        </CardHeader>
