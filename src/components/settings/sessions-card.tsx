      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Saia de todos os dispositivos em que você está conectado —
            incluindo este. Útil se você perdeu um notebook ou compartilhou
            sua senha.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Todos os dispositivos conectados a esta conta serão
              desconectados e precisarão entrar novamente. Você será
