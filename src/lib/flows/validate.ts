    ...
    case "send_message": {
      ...
      if (!cfg.text?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "text",
          message: "O nó de mensagem precisa de um corpo de texto.",
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O nó de mensagem aponta para um nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "send_media": {
      ...
      if (
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "media_type",
          message: "O nó de mídia precisa de um tipo de mídia (imagem, vídeo ou documento).",
        });
      }
      ...
      if (!cfg.next_node_key) {
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O nó de mídia aponta para um nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "collect_input": {
      ...
      if (!cfg.prompt_text?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "prompt_text",
          message: "O nó de coleta de dados precisa de um texto de pergunta para enviar ao cliente.",
        });
      }
      if (!cfg.var_key?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "var_key",
          message: "O nó de coleta de dados precisa de um var_key para armazenar a resposta.",
        });
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "var_key",
          message: `var_key "${cfg.var_key}" deve conter apenas letras, números e sublinhados, começando por uma letra ou sublinhado.`,
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: "O nó de coleta de dados precisa apontar para um próximo nó.",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O nó de coleta de dados aponta para um nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "set_tag": {
      ...
      if (!cfg.mode || !["add", "remove"].includes(cfg.mode)) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "mode",
          message: "O nó de etiqueta precisa de um modo (add ou remove).",
        });
      }
      if (!cfg.tag_id) {
        issues.push({
      ...
      if (!cfg.next_node_key) {
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O nó de etiqueta aponta para um nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
